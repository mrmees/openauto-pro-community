...
MusicApplicationMenu {
    ...
    title: qsTr("Setup RTL-SDR FM plugin")
    objectName: "RtlSdrFmSetupPluginMenu"
    id: root
    ...
    Item {
        ...
        NormalText {
            ...
            text: qsTr("Setup your instance of plugin in order to use <b>RTL-SDR FM</b> device with OpenAuto Pro.<br><b>Do not have the plugin yet? </b>Visit our web page at <b>www.bluewavestudio.io</b> to get it!")
            ...
            Item {
                ...
                Item {
                    ...
                    Image {
                        ...
                        height: width
                        anchors.centerIn: parent
                        source: LicenseController.rtlSdrFmPluginValid ? "/images/ico_done.svg" : "/images/ico_fail.svg"
                    }
                }
            ...
            Item {
                ...
                Item {
                    ...
                    Image {
                        ...
                        height: width
                        anchors.centerIn: parent
                        source: (LicenseController.rtlSdrFmPluginValid
                                 && LicenseController.rtlSdrFmLicenseValid) ? "/images/ico_done.svg" : "/images/ico_fail.svg"
                    }
                }
