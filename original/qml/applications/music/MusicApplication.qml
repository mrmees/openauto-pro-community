...
MusicApplicationMenu {
    id: root
    title: qsTr("Autobox music")
    objectName: "AutoboxMusicMenu"
        ...
        Item {
            ...
            Item {
                ...
                ForegroundShape {
                    ...
                    Image {
                        ...
                        asynchronous: true
                        anchors.centerIn: parent
                        source: AutoboxController.coverArtUrl
                        width: parent.width * 0.975
                        height: parent.height * 0.975
                        mipmap: true
                        antialiasing: true
            ...
            Item {
                ...
                ColumnLayout {
                    ...
                    NormalText {
                        id: titleLabel
                        scrollableText: AutoboxController.title
                    ...
                    NormalText {
                        id: artistLabel
                        scrollableText: AutoboxController.artist
                    ...
                    NormalText {
                        id: albumLabel
                        scrollableText: AutoboxController.album
                        fontPixelSize: parent.height * 0.105
                        elide: Text.ElideRight
                        Layout.preferredWidth: parent.width
                    }
                    ...
                    Item {
                        ...
                        SimpleSlider {
                            ...
                            anchors.fill: parent
                            from: 0
                            to: AutoboxController.duration
                            readOnly: true
                            stepSize: 1000
                            active: false

                            Component.onCompleted: {
                                seekSlider.value = AutoboxController.position
                            }
                        }
                        ...
                        NormalText {
                            ...
                            text: AutoboxController.positionLabel
                            fontPixelSize: parent.height * 0.45

                            Component.onCompleted: {
                                positionLabel.text = AutoboxController.positionLabel
                            }
                        }
                        ...
                        NormalText {
                            ...
                            anchors.top: seekSlider.bottom
                            text: AutoboxController.durationLabel
                            fontPixelSize: parent.height * 0.45
                        }
        ...
        Item {
            ...
            RowLayout {
                ...
                BarIcon {
                    ...
                    Layout.preferredWidth: parent.buttonWidth
                    Layout.alignment: Qt.AlignHCenter
                    source: AutoboxController.isPlaying ? "/images/ico_pause_white.svg" : "/images/ico_play_white.svg"
                    onTriggered: {
                        AutoboxController.togglePlay()
                    }
                }
    ...
    Component.onCompleted: {
        NotificationsController.suspendChannel(
                    AutoboxController.notificationsChannelId)
    }
