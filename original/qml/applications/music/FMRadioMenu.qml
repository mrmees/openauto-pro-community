...
MusicApplicationMenu {
    ...
    id: root
    title: qsTr("Storage music")
    defaultControl: seekSlider
    objectName: "StorageMusicMenu"
        ...
        Item {
            ...
            Item {
                ...
                ForegroundShape {
                    ...
                    Image {
                        ...
                        asynchronous: true
                        anchors.centerIn: parent
                        source: StorageMusicController.coverArtUrl
                        width: parent.width * 0.975
                        height: parent.height * 0.975
                        mipmap: true
                        antialiasing: true
            ...
            Item {
                ...
                ColumnLayout {
                    ...
                    NormalText {
                        id: titleLabel
                        scrollableText: StorageMusicController.title
                    ...
                    NormalText {
                        id: artistLabel
                        scrollableText: StorageMusicController.artist
                    ...
                    NormalText {
                        id: albumLabel
                        scrollableText: StorageMusicController.album
                        fontPixelSize: parent.height * 0.105
                        elide: Text.ElideRight
                        Layout.preferredWidth: parent.width
                    }
                    ...
                    Item {
                        ...
                        SimpleSlider {
                            ...
                            anchors.fill: parent
                            from: 0
                            to: StorageMusicController.duration
                            readOnly: !StorageMusicController.isSeekable
                            stepSize: 1

                            onValueChanged: {
                                if (seekSlider.value !== StorageMusicController.position) {
                                    StorageMusicController.position = seekSlider.value
                                }
                            }

                            Component.onCompleted: {
                                seekSlider.value = StorageMusicController.position
                            }
                        }
                        ...
                        NormalText {
                            ...
                            Component.onCompleted: {
                                positionLabel.text = StorageMusicController.positionLabel
                            }
                        }
                        ...
                        NormalText {
                            ...
                            anchors.top: seekSlider.bottom
                            text: StorageMusicController.durationLabel
                            fontPixelSize: parent.height * 0.45
                        }

                        Connections {
                            target: StorageMusicController
                            onPositionChanged: {
                                seekSlider.value = StorageMusicController.position
                                positionLabel.text = StorageMusicController.positionLabel
                            }
        ...
        Item {
            ...
            RowLayout {
                ...
                BarIcon {
                    ...
                    onTriggered: {
                        StorageMusicController.previous()
                    }
                }
                ...
                BarIcon {
                    ...
                    Layout.preferredWidth: parent.buttonWidth
                    Layout.alignment: Qt.AlignHCenter
                    source: StorageMusicController.isPlaying ? "/images/ico_pause_white.svg" : "/images/ico_play_white.svg"
                    onTriggered: {
                        StorageMusicController.togglePlay()
                    }
                }
                ...
                ShuffleModeIcon {
                    ...
                    Layout.preferredWidth: parent.buttonWidth
                    Layout.alignment: Qt.AlignHCenter
                    active: StorageMusicController.shuffleEnabled
                    onTriggered: {
                        StorageMusicController.toggleShuffleMode()
                    }
                }
                ...
                RepeatModeIcon {
                    ...
                    Layout.preferredWidth: parent.buttonWidth
                    Layout.alignment: Qt.AlignHCenter
                    mode: StorageMusicController.repeatMode
                    onTriggered: {
                        StorageMusicController.toggleRepeatMode()
                    }
                }
            }
        }
